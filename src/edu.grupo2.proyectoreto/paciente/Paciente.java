...
public final class Paciente implements Serializable {
    ...
    /**
     * Expediente, es una lista de Ingresos, cada ingreso representanto las veces que el paciente estubo
     ...
     * @param apellido apellido del paciente, no acepta null ni cadena llena de espacios
     * 
     ...
     * por parametro.
     * 
     * Solo se podra crear un nuevo ingreso, si el paciente no tiene ningún ingreso activo. Es decir, solo si
     ...
     * @throws IllegalStateException    si se intenta crear un nuevo ingreso cuando el paciente ya tiene su último
     *                                  ingreso activo
     */
    public void crearIngreso(LocalDate fechaIngreso, List<String> enfermedadesMentales, boolean discapacidad) {

        // Si el paceinte tiene ingresos y el último ingreso del paciente está activo, no se podra crear otro
        ...
        // En caso de que no tenga ingresos o su último ingreso no se un ingreso activo, se crea uno.
